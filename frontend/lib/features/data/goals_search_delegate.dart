...
class GoalsSearchDelegate extends SearchDelegate {
  final List<String>? selected;
  GoalsSearchDelegate({this.selected, required this.area});
      ...
      child: SafeArea(
        child: HookConsumer(
          builder: (context, ref, child) {
            ...
            final goals = Data.getGoals(area);

            final selectedTag = useState<String?>(null);

            final tags =
                Data.tagMap.entries
                    .where((e) => goals.map((e)=> e.split('-').first).contains('${e.key}CG'))
                    .toList();
                      ...
                      child: ListView(
                        children:
                            goals
                                ...
                                .where((e)=> selectedTag.value != null? e.split('-').first == '${selectedTag.value}CG' : true)
                                .map((e) {
                                  final value = Data.getGoal(e);

...
class _SchoolRepository implements SchoolRepository {
  _SchoolRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<School> createSchool(School school) async {
    ...
    final _options = _setStreamType<School>(
    ...
    late School _value;
    try {
      _value = School.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<School> updateSchool(String id, School school) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
